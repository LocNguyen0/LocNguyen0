                                        ...
                                        <tr>
                                            <td>
                                                <img class="byder_thumb wh_56"
                                                    src="{{ asset('theme/admin/img/Payment/1.png') }}" alt>
                                            </td>
                                            <td>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/1.png') }}" alt></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/2.png') }}" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/3.png') }}" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/4.png') }}" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/5.png') }}" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/6.png') }}" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_1.png') }}" alt>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_2.png') }}" alt>
                                                    </div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_3.png') }}" alt>
                                                    </div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_4.png') }}" alt>
                                                    </div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_5.png') }}" alt>
                                                    </div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_6.png') }}" alt>
                                                    </div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                </div>
                                            </td>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_62 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_big.png') }}"
                                                            alt></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_62 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_big_1.png') }}"
                                                            alt></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_62 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="{{ asset('theme/admin/img/customers/pro_big_2.png') }}"
                                                            alt></div>
...
@section('scripts-libs')
    <script src="{{ asset('theme/admin/js/jquery1-3.4.1.min.js') }}"></script>

    <script src="{{ asset('theme/admin/js/popper1.min.js') }}"></script>

    <script src="{{ asset('theme/admin/js/bootstrap.min.js') }}"></script>

    <script src="{{ asset('theme/admin/js/metisMenu.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/count_up/jquery.waypoints.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/chartlist/Chart.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/count_up/jquery.counterup.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/niceselect/js/jquery.nice-select.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/owl_carousel/js/owl.carousel.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/datatable/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/dataTables.responsive.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/buttons.flash.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/jszip.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/pdfmake.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/vfs_fonts.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datatable/js/buttons.print.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/datepicker/datepicker.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datepicker/datepicker.en.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/datepicker/datepicker.custom.js') }}"></script>
    <script src="{{ asset('theme/admin/js/chart.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chartjs/roundedBar.min.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/progressbar/jquery.barfiller.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/tagsinput/tagsinput.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/text_editor/summernote-bs4.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/am_chart/amcharts.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/scroll/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/scroll/scrollable-custom.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/vectormap-home/vectormap-2.0.2.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/vectormap-home/vectormap-world-mill-en.js') }}"></script>

    <script src="{{ asset('theme/admin/vendors/apex_chart/apex-chart2.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/apex_chart/apex_dashboard.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/echart/echarts.min.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chart_am/core.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chart_am/charts.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chart_am/animated.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chart_am/kelly.js') }}"></script>
    <script src="{{ asset('theme/admin/vendors/chart_am/chart-custom.js') }}"></script>

    <script src="{{ asset('theme/admin/js/dashboard_init.js') }}"></script>
...
@section('style-libs')
    <link rel="stylesheet" href="{{ asset('theme/admin/css/bootstrap1.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/themefy_icon/themify-icons.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/niceselect/css/nice-select.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/owl_carousel/css/owl.carousel.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/gijgo/gijgo.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/font_awesome/css/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/tagsinput/tagsinput.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/datepicker/date-picker.css') }}" />
    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/vectormap-home/vectormap-2.0.2.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/scroll/scrollable.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/datatable/css/jquery.dataTables.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/datatable/css/responsive.dataTables.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/datatable/css/buttons.dataTables.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/text_editor/summernote-bs4.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/morris/morris.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/vendors/material_icon/material-icons.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/css/metisMenu.css') }}" />

    <link rel="stylesheet" href="{{ asset('theme/admin/css/style1.css') }}" />
    <link rel="stylesheet" href="{{ asset('theme/admin/css/colors/default.css') }}" id="colorSkinCSS" />
@endsection
