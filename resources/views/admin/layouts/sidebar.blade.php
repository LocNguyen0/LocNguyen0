<nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    <div class="logo d-flex justify-content-between">
        <a href="index-2.html"><img src="{{ asset('theme/admin/img/l"') }} alt></a>
    ...
    <ul id="sidebar_menu">
        <li class="mm-active">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/dashboard') }}.svg" alt>
                </div>
                <span>Dashboard</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/2') }}.svg" alt>
                </div>
                <span>Apps</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/3') }}.svg" alt>
                </div>
                <span>UI Kits</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/4') }}.svg" alt>
                </div>
                <span>forms</span>
            </a>
            <ul>
        ...
        <li class>
            <a href="Board.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/5') }}.svg" alt>
                </div>
                <span>Board</span>
            </a>
        </li>
        <li class>
            <a href="invoice.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/6') }}.svg" alt>
                </div>
                <span>Invoice</span>
            </a>
        </li>
        <li class>
            <a href="calender.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/7') }}.svg" alt>
                </div>
                <span>Calander</span>
            </a>
        </li>
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/8') }}.svg" alt>
                </div>
                <span>Products</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/9') }}.svg" alt>
                </div>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/10') }}.svg" alt>
                </div>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/11') }}.svg" alt>
                </div>
                <span>Table</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/12') }}.svg" alt>
                </div>
                <span>Cards</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/13') }}.svg" alt>
                </div>
                <span>Charts</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/14') }}.svg" alt>
                </div>
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/15') }}.svg" alt>
                </div>
                <span>Maps</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('theme/admin/img/menu-icon/16') }}.svg" alt>
                </div>
                <span>Pages</span>
            </a>
            <ul>
